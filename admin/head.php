                        ...
                        <th>
                            <div class="container">
                                <div class="row methods mt-3 mb-4 rounded">
                                    ...
                                    <a class="col nav-link p-2 active" href="./head.php" >Head</a>
...
?>
        ...
        <table class="table table-dark table-striped mt-1">
            ...
            <tbody>
                <?php
                $select = $con->prepare(' select * from heads where apply = 1 ');
                $select->execute();
            ...
            ?>
                ...
                echo $plants[0]["name"] ;
                    ...
                    <button class="btn btn-secondary " onclick="editcommitte(`<?=$committe['name']?>` ,`<?=$committe['phoneNum']?>`,`<?=$committe['id']?>`)">update</button>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
